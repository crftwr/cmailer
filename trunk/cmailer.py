...
"""
## @mainpage CraftMailer APIリファレンス
#
#  CraftMailerのカスタマイズや機能拡張をするためのリファレンスです。\n
#  \n
#  CraftMailerのオフィシャルサイトはこちらです。\n
#  http://sites.google.com/site/craftware/cmailer/ \n
#  \n
#  @par クラス
#  @ref cmailer_mainwindow.MainWindow        "MainWindow クラス"             \n
#  \n
#  @ref cmailer_listwindow.ListWindow        "ListWindow クラス"             \n
#  @ref cmailer_listwindow.ListItem          "ListItem クラス"               \n
#  \n
